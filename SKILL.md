---
name: xxd-panel-184
description: "Create Panel 184 raster artwork: Hand-drawn Square Everyday Vignette. Use when the user invokes xxd-panel-184 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-184/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-184-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
